...
// GameRouter builds and returns the chi router with all routes mounted.
...
func GameRouter(r chi.Router, h *GameHandler, middlewares ...func(http.Handler) http.Handler) {
